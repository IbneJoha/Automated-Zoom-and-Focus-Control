...
int desiredValue1 = 152;  // Target for Motor 1 (will be updated from Python)
int desiredValue2 = 122;  // Target for Motor 2 (will be updated from Python)
...
void loop() {
  ...
  delay(10); // 30ms delay between updates
}
