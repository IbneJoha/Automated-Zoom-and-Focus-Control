...
if sys.platform == 'win32':
    g_DLL = ctypes.windll.LoadLibrary(r"C:\Users\Joha\Desktop\ZOOM Software\LensConnect_SampleProgram_Python_x64_1.0.0\LensConnect_Controller\SLABHIDDevice.dll")
